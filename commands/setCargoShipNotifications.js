...
module.exports = {
    ...
    execute(author, message, channel, args, discordBot, rustplus) {
        ...
        if (args.length != 1) {
            Tools.print("ERROR", "1 argument required. Example: !setCargoShipNotifications true.", channel);
            return false;
        }
        ...
        Tools.print("Successfully Set", "Cargo Ship Notifications was set to **" + args[0] + "**.");
