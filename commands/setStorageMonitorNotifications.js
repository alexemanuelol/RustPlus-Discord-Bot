...
module.exports = {
    ...
    execute(author, message, channel, args, discordBot, rustplus) {
        ...
        if (args.length != 1) {
            Tools.print("ERROR", "1 argument required. Example: !setStorageMonitorNotifications true.", channel);
            return false;
        }
        ...
        Tools.print("Successfully Set", "Storage Monitor Notifications was set to **" + args[0] + "**.");
