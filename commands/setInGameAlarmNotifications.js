...
module.exports = {
    ...
    execute(author, message, channel, args, discordBot, rustplus) {
        ...
        if (args.length != 1) {
            Tools.print("ERROR", "1 argument required. Example: !setInGameAlarmNotifications true.", channel);
            return false;
        }
        ...
        Tools.print("Successfully Set", "In-Game Alarm Notifications was set to **" + args[0] + "**.");
